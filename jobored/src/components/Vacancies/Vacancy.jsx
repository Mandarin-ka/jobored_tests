...
const Vacancy = ({key, name, salaryFrom, salaryTo, currency, time, location}) => {
  ...
  return (
    <div className={cl.vacancy__item} data-elem={`vacancy-${key}`}>
      ...
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#ACADB9" className={isFavorite ? cl.star.active : cl.star} onClick={setFavorite}>
